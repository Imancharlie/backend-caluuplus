...
from .models import User, University, College, Program, Course, Student, StudentCourse, TimetableSlot, Article, Notification, Slide, HelpMessage, Quote, UniversityAmbassador, UniversityLink


@admin.register(User)
class CustomUserAdmin(UserAdmin):
    list_display = ('email', 'display_name', 'gender', 'phone_number', 'is_staff', 'is_active')
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('display_name', 'first_name', 'last_name', 'gender', 'phone_number')}),
